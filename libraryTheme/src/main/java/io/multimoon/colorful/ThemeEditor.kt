...
class ThemeEditor(
    internal var primaryColor: ThemeColorInterface = ThemeColor.INDIGO,
    internal var accentColor: ThemeColorInterface = ThemeColor.RED,
    internal var darkTheme: Boolean = true,
    internal var translucent: Boolean,
    internal @StyleRes var customTheme: Int = 0,
) {
