...
import com.lzy.okgo.utils.MapParams;
...
public abstract class Request<T, R extends Request> implements Serializable {
    ...
    @SuppressWarnings("unchecked")
    public R paramsCustom(Map<String, Object> map, boolean... isReplace) {
        String json = MapParams.getRequestMapParams(map);
        params.put("param", json, isReplace);
        return (R) this;
    }
